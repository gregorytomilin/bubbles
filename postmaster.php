<?php
$EMAIL = 'tomigri.ru@gmail.com'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'info@bubbles.com';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
...
switch (@$_POST['action']) { // рассматриваем варианты разных значений поля action
    ...
    break;
    case 'callme_order':
        sendmail("Письмо с сайта", render(
                        '<div><b>Имя:</b> '.stripinput($_POST['name']).'</div>'.
